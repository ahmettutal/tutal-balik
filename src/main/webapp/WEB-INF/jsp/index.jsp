            ...
            <div class="category-nav">
                ...
                <ul class="category-list">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <ul class="list-links">
                                        ...
                                        <li><a href="#">SURF KAMIŞLAR</a></li>
                                    </ul>
                                    <hr>
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">SPİN KAMIŞLAR</a></li>
                                    </ul>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">GENEL KULLANIM</a></li>
                                        <li><a href="#">BOT KAMIŞLARI</a></li>
                    ...
                    <li class="dropdown side-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                                          aria-expanded="true">MAKİNALAR <i
                            class="fa fa-angle-right"></i></a>
                        <div class="custom-menu">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">SURF MAKİNALAR</a></li>
                                    </ul>
                                    <hr>
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">SPİN MAKİNALAR</a></li>
                                    </ul>
                                    <hr class="hidden-md hidden-lg">
                                </div>
                    ...
                    <li class="dropdown side-dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">MİSİNALAR<i
                                class="fa fa-angle-right"></i></a>
                        <div class="custom-menu">
                            <div class="row">
                                <div class="col-md-4">
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">MONOFLENT MİSİNALARI</a></li>
                                    ...
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">FLOROCARBON MİSİNA</a></li>
                    ...
                    <li class="dropdown side-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                                          aria-expanded="true">SUNİ YEMLER <i
                            class="fa fa-angle-right"></i></a>
                        <div class="custom-menu">
                            <div class="row">
                                <div class="col-md-4">
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">SİLİKONLAR</a></li>
                                    </ul>
                                    <hr>
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">RAPALALAR</a></li>
                                    </ul>
                                    <hr class="hidden-md hidden-lg">
                                </div>
                                <div class="col-md-4">
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">KAŞIKLAR</a></li>
                                    </ul>
                                    <hr>
                                    <ul class="list-links">
                                        <li>
                                            <h3 class="list-links-title"></h3></li>
                                        <li><a href="#">JİG HEADLAR</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-4 hidden-sm hidden-xs">
                                    <a class="banner banner-2" href="#">
                                        <img src="/img/suni-balık.jpg" alt="">
                                        <div class="banner-caption">
                    ...
                    <li class="dropdown side-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                                          aria-expanded="true">İĞNELER <i class="fa fa-angle-right"></i></a>
                        <div class="custom-menu">
                            <div class="row">
                                <div class="col-md-4">
                                    <ul class="list-links">
                    ...
                    <li class="dropdown side-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="custom-menu">
                            <div class="row">
                                ...
                                <div class="col-md-4 hidden-sm hidden-xs">
                                    <a class="banner banner-2" href="#">
                                        <img src="/img/kutu-ve-çanta.jpg" alt="">
                                        <div class="banner-caption">
                    ...
                    <li class="dropdown side-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="custom-menu">
                            <div class="row">
                                ...
                                <div class="col-md-4 hidden-sm hidden-xs">
                                    <a class="banner banner-2" href="#">
                                        <img src="/img/SAZAN-MALZEMELERİ.jpg" alt="">
                                        <div class="banner-caption">
